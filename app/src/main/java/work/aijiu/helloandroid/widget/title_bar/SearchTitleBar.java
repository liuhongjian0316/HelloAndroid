package work.aijiu.helloandroid.widget.title_bar;
...
import work.aijiu.helloandroid.impl.OnLimitClickHelper;
import work.aijiu.helloandroid.impl.OnLimitClickListener;
...
public class SearchTitleBar extends LinearLayout implements OnLimitClickListener {
    ...
    public void setHint(String hint) {
        if (TextUtils.isEmpty(hint)) {
            ...
            searchEt.setPadding(ResourceUtils.getResourcesDimension(R.dimen.dimen_size_5), 0, 0, 0);
        }
